...
<html>
    ...
    .copyright p {
  	...
  	<body style="background: #fff;
    	...
    	padding: 20px 0px;
    	margin: 0 auto;">
  			<img src="<?php echo config('app.url') ?>/assets/image/ctc.jpg" alt="logo" style="max-height: 60px;">
  		</div>
    	...
    	color: #555555;">Halo {{$name}},</p>
	  			<p style="font-size: 11px;
    	color: #555555;">Kami telah mencatat anda sebagai peserta <i>technical meeting</i> Cemat-Transasia-ColdChain 2017.</p>
	  			<p style="font-size: 11px;
