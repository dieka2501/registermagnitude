  	...
  	<body style="background: #fff;
    	...
    	-moz-border-radius: 10px;">
	  		<div class="content" style="padding: 20px;">
	  			<h4>Terima Kasih Telah Melakukan Pendaftaran</h4>
	  			<p style="font-size: 11px;
    	color: #555555;">Halo {{$nama}},</p>
	  			<p style="font-size: 11px;
    	color: #555555;">Anda telah mendaftar sebagai pengunjung CeMAT Southeast Asia.</p>
	  			<p style="font-size: 11px;
    	color: #555555;">Silakan klik tautan di bawah, untuk melakukan verifikasi <i>email</i> Anda.</p>
        <p style="font-size: 11px;
        color: #555555;"><?php echo $link?></p>
    	...
    	padding: 20px;">
	  			...
	  			<p style="line-height: 5px;">CeMAT Southeast Asia</p>
	  			</div>
	  		</div>
	  	</div>
  	</body>
